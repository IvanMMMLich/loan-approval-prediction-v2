"""
Step 5.3: Evaluate — Random Forest + Метрики + Анализ

============================================================================
ЧТО ДЕЛАЕМ:
============================================================================

1. Загружаем данные с новым признаком rate_deviation
...
DATA_DIR = PROJECT_ROOT / 'data' / 'processed' / 'step5' / '3_aggregations'
RESULTS_DIR = PROJECT_ROOT / 'results' / 'step5_feature_engineering' / '3_aggregations'
...
def main():
    print("\n" + "="*70)
    print("STEP 5.3: EVALUATE — AGGREGATIONS")
    print("="*70)
    ...
    print(f"Новый признак: rate_deviation ✓")
    ...
    print_metrics(metrics, title="RF with rate_deviation")
