"""
Step 5.2: Evaluate — Random Forest + Метрики + Анализ

============================================================================
ЧТО ДЕЛАЕМ:
============================================================================

1. Загружаем данные с новым признаком remaining_income
2. Кодируем категориальные признаки (Ordinal Encoding)
3. Обучаем Random Forest baseline
4. Считаем метрики
5. Визуализация + Анализ (Pearson, Spearman, Permutation Importance)
...
DATA_DIR = PROJECT_ROOT / 'data' / 'processed' / 'step5' / '2_combinations'
RESULTS_DIR = PROJECT_ROOT / 'results' / 'step5_feature_engineering' / '2_combinations'
...
def main():
    print("\n" + "="*70)
    print("STEP 5.2: EVALUATE — COMBINATIONS")
    print("="*70)
    ...
    print(f"Новый признак: rate_burden ✓")
    ...
    print_metrics(metrics, title="RF with rate_burden")
    ...
    # Новый признак для выделения красным
    new_features = ['rate_burden']
