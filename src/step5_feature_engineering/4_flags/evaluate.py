"""
Step 5.4: Evaluate — Random Forest + Метрики + Анализ

============================================================================
ЧТО ДЕЛАЕМ:
============================================================================

1. Загружаем данные с новым признаком intent_default_risk
   (loan_intent и cb_person_default_on_file уже удалены)
2. Кодируем категориальные признаки (Ordinal Encoding)
3. Обучаем Random Forest baseline
4. Считаем метрики
5. Визуализация + Анализ
...
DATA_DIR = PROJECT_ROOT / 'data' / 'processed' / 'step5' / '4_flags'
RESULTS_DIR = PROJECT_ROOT / 'results' / 'step5_feature_engineering' / '4_flags'
...
# ============================================================================
# ORDINAL ENCODING (без loan_intent и cb_person_default_on_file!)
# ============================================================================
...
def main():
    ...
    print(f"Новый признак: intent_default_risk ✓")
    ...
    print("(intent_default_risk уже числовой — 1-12)")
    ...
    print_metrics(metrics, title="RF with intent_default_risk")
    ...
    new_features = ['intent_default_risk']
    ...
    print(f"\nСравните с baseline:")
    print(f"   • Было 9 признаков, стало 8")
    print(f"   • loan_intent + default → intent_default_risk")
